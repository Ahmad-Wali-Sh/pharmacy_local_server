...
const PrescriptionTroughIncludes = [
...
router.get('/prescriptions', authenticate, GenericController.handleGetAll(Prescription, {include: PrescriptionIncludes}));
...
router.get('/prescriptions/last', authenticate, GenericController.handleLast(Prescription, {include: PrescriptionIncludes}));
router.get('/prescription/previous/:id', authenticate, GenericController.handlePrevious(Prescription, {include: PrescriptionIncludes}));
router.get('/prescription/next/:id', authenticate, GenericController.handleNext(Prescription, {include: PrescriptionIncludes}));
